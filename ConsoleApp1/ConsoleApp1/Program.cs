...
//            double[] arr = { 1, 5, 7, 23, 76, 98, 90, 35, 28, 67 };
//            //var query1 = from i in arr
//            //                 // where i >= 40
//            //            where i >7 && i<=100 
...
//            Console.WriteLine("Count is: " + result1);

//            double result2 = arr.Max();
//            Console.WriteLine("Max is: " + result2);

//            int result3 = arr.Min();
//            Console.WriteLine("Min is: " + result3);

//            int result4 = arr.Average();
//            Console.WriteLine("Count is: " + result4);
